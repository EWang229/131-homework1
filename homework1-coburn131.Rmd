...
I would say that this is a predictive problem because we want to predict the outcome (likeiness of voting in favor of the candidate) based on a given set of attributes.  
