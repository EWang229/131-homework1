...
These relationships make sense because if cty and hwy are strongly, positively correlated, then it makes sense that both of them would have a similar relationship to a given variable from the dataset.